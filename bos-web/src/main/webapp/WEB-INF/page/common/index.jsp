...
$(function() {
		...
		$("#btnEp").click(function(){
			...
			if(v){
				...
				if(v1 == v2){
					//两次输入一致，发送ajax请求
					$.post("userAction_changePassword.action",{"newPassword":v1,"rePassword":v2},function(data){
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
               <form id="editPasswordForm">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input data-options="required:true" id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input data-options="required:true" id="txtRePass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                </table>
                </form>
            </div>
